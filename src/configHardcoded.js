...
const overlaysData = {
    "primary": [
        ...
        {
            "url": "/imports/overlays/external_sources/sofenhagen_routes.kml",
    ...
    "secondary": [
        {
            "url": "/imports/overlays/misc_layers/crossings.kml",
            "label": "Пресичания / Crossings",
            "icon": "directions_walk",
            "disabled": false
        },
        {
            "url": "/imports/overlays/misc_layers/transport.kml",
            "label": "Транспорт / Transport",
            "icon": "train",
            "disabled": false
        },
        {
            "url": "/imports/overlays/misc_layers/others.kml",
            "label": "Други / Others",
            "icon": "quiz",
            "disabled": true
        },
        {
            "url": "/imports/overlays/external_sources/bike_parking.kml",
    ...
    "external": [
        {
            "url": "/imports/overlays/external_sources/mtb_bg.kml",
        ...
        {
            "url": "/imports/overlays/external_sources/alabak.kml",
